...
<script>
	...
	function openDocument(docId){
		...
		window.open('documentDetails?documentId='+docId,'팝업스','width=500, height=500, left='+left+', top='+popupY+', menubar=no, status=no, toolbar=no')
...
<body>
	...
	<div class=container>
		<div class=container-div>
			...
			<h1 style="margin-top:-30px;" >버킷 리스트</h1><br><br>
